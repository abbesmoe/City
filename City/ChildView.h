...
private:
    ...
    void AddTransporter(const std::wstring& file);
    ...
    bool mShowHistory = false;      ///< keep track of the on/off status of the Mouse History menu

    bool mTransportActive = false;        ///< keep track of the on/off status of the Transport menu

    bool mFirstTransporter = true;
